...
//           <div
//             key={index}
//             className="flex flex-col rounded-lg overflow-hidden transition-shadow duration-300"
//           >
//             {/* Image with hover */}
...
//               {/* Rating */}
//               {item.rating && (
//                 <div className="flex items-center justify-center text-yellow-500 mt-2 text-lg">
//                   {'★'.repeat(item.rating)}
